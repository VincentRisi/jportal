...
JP_INTERNAL(int) JP_BindLong(TJQuery &qry,    text* Name, int bindNo, long    &Data);
JP_INTERNAL(int) JP_BindInt(TJQuery &qry,     text* Name, int bindNo, int     &Data);
JP_INTERNAL(int) JP_BindShort(TJQuery &qry,   text* Name, int bindNo, short   &Data);
...
JP_INTERNAL(int) JP_BindLongNull(TJQuery &qry,    text* Name, int bindNo, long    &Data, short &Null);
JP_INTERNAL(int) JP_BindIntNull(TJQuery &qry,     text* Name, int bindNo, int     &Data, short &Null);
JP_INTERNAL(int) JP_BindShortNull(TJQuery &qry,   text* Name, int bindNo, short   &Data, short &Null);
...
JP_INTERNAL(int) JP_BindLongArray(TJQuery &qry,    text* Name, int bindNo, long    *Data);
JP_INTERNAL(int) JP_BindIntArray(TJQuery &qry,     text* Name, int bindNo, int     *Data);
JP_INTERNAL(int) JP_BindShortArray(TJQuery &qry,   text* Name, int bindNo, short   *Data);
...
JP_INTERNAL(int) JP_DefineLong(TJQuery &qry,     int defineNo, long *data);
JP_INTERNAL(int) JP_DefineInt(TJQuery &qry,      int defineNo, int *data);
JP_INTERNAL(int) JP_DefineShort(TJQuery &qry,    int defineNo, short *data);
...
JP_INTERNAL(void) JP_GetLong(TJQuery &qry,       long   &into, char *from);
JP_INTERNAL(void) JP_GetInt(TJQuery &qry,        int    &into, char *from);
JP_INTERNAL(void) JP_GetShort(TJQuery &qry,      short  &into, char *from);
...
JP_INTERNAL(void) JP_GetNull(TJQuery &qry, short &into, int defineNo);

JP_INTERNAL(void) JP_PutString(TJQuery &qry,     char *into, char   *from, int dataLen);
JP_INTERNAL(void) JP_PutLong(TJQuery &qry,       char *into, long   &from);
JP_INTERNAL(void) JP_PutInt(TJQuery &qry,        char *into, int    &from);
JP_INTERNAL(void) JP_PutShort(TJQuery &qry,      char *into, short  &from);
...
JP_INTERNAL(void) JP_PutNull(TJQuery &qry, short &from, int bindNo);
...
void TJQuery::Bind(const char* name, int bindNo, char *data, int dataLen, short *null, int ansichar)
{
  int result;
  if (null)
...
void TJQuery::Bind(const char* name, int bindNo, long &data, short *null)
{
  int result;
  if (null)
...
void TJQuery::Bind(const char* name, int bindNo, int &data, short *null)
{
  int result;
  if (null)
...
void TJQuery::Bind(const char* name, int bindNo, short &data, short *null)
{
  int result;
  if (null)
...
void TJQuery::Bind(const char* name, int bindNo, double &data, short *null)
{
  int result;
  if (null)
...
void TJQuery::Bind(const char* name, int bindNo, TJOCIDate &data, short *null)
{
  int result;
  if (null)
...
void TJQuery::Bind(const char* name, int bindNo, OCILobLocator *data, int lobType, short *null)
{
  int result;
  if (null)
...
void TJQuery::BindArray(const char* name, int bindNo, long *data)
{
  int result;
...
void TJQuery::BindArray(const char* name, int bindNo, int *data)
{
  int result;
...
void TJQuery::BindArray(const char* name, int bindNo, short *data)
{
  int result;
...
void TJQuery::Define(int defineNo, long *data)
{
  if (JP_DefineLong(*this, defineNo, data))
    conn.ThrowOnError(file, line);
}

void TJQuery::Define(int defineNo, int *data)
{
  if (JP_DefineInt(*this, defineNo, data))
    conn.ThrowOnError(file, line);
}

void TJQuery::Define(int defineNo, short *data)
{
...
void TJQuery::Get(long &into, char *from)
{
  JP_GetLong(*this, into, from);
}

void TJQuery::Get(int &into, char *from)
{
  JP_GetInt(*this, into, from);
}

void TJQuery::Get(short &into, char *from)
{
...
void TJQuery::GetNull(short &into, int defineNo)
{
...
void TJQuery::Put(char *into, long &from)
{
  JP_PutLong(*this, into, from);
}

void TJQuery::Put(char *into, int &from)
{
  JP_PutInt(*this, into, from);
}

void TJQuery::Put(char *into, short &from)
{
...
void TJQuery::PutNull(short &from, int bindNo)
{
...
JP_INTERNAL(void) JP_GetLong(TJQuery &qry, long &into, char *from)
{
  into = *(long *)(from+(qry.rowsIndex*sizeof(long)));
}

JP_INTERNAL(void) JP_GetInt(TJQuery &qry, int &into, char *from)
{
  into = *(int *)(from+(qry.rowsIndex*sizeof(int)));
}

JP_INTERNAL(void) JP_GetShort(TJQuery &qry, short &into, char *from)
{
  into = *(short *)(from+(qry.rowsIndex*sizeof(short)));
}
...
JP_INTERNAL(void) JP_PutLong(TJQuery &qry,       char *into, long   &from)
{
  *(long *)(into+(qry.rowsIndex*sizeof(long))) = from;
}

JP_INTERNAL(void) JP_PutInt(TJQuery &qry,        char *into, int    &from)
{
  *(int *)(into+(qry.rowsIndex*sizeof(int))) = from;
}

JP_INTERNAL(void) JP_PutShort(TJQuery &qry,      char *into, short  &from)
{
  *(short *)(into+(qry.rowsIndex*sizeof(short))) = from;
}
