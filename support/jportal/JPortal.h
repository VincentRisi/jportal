 ...
 * Author:    Vincent Risi (vincent.risi@gmail.com)
 * Created:   2015-11-01
 * Copyright: Vincent Risi
 * License:   GPL
 **************************************************************/

#ifndef JPORTAL_H_INCLUDED
#define JPORTAL_H_INCLUDED
...
class JPortal : public cbToolPlugin
{
    public:
        /** Constructor. */
        JPortal();
